...
class AboutIteration(Koan):
    ...
    def test_map_transforms_elements_of_a_list(self):
        ...
        self.assertEqual([x+10 for x in seq], mapped_seq)
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce evaluates a function on each element of a list, but
        # that function's arguments are both the current element and
        # the result of applying the function to the previous element.
